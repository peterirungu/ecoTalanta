		...
		<div class="container">
            <div class="navbar-identity">
    			<a href="index.php" class="navbar-brand logo logo-title">
    			   <span class="logo-icon"><i class="fas fa-recycle ln-shadow-logo "></i></span>eco-<span>Talanta </span> 
                </a>
    			...
    			<button class="flag-menu country-flag d-block d-md-none btn btn-secondary hidden pull-right" href="#select-country" data-toggle="modal">
                    <span class="flag-icon flag-icon-ke"></span>  <span class="caret"></span>
    			</button>
            </div>
					...
					<li class="dropdown no-arrow nav-item">
						...
						<ul class="dropdown-menu user-menu dropdown-menu-right">
							...
							<li class="dropdown-item">
								<a href="#"> <i class="icon-th-thumb"></i> My Products </a>
							</li>							
							<li class="dropdown-item">
								<a href="#"><i class="icon-hourglass"></i> Orders </a>
							</li>
							<li class="dropdown-item">
								<a href="#"><i class=" icon-money "></i> Messages </a>
							</li>
							<li class="dropdown-item">
